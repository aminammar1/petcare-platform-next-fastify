...
const Tracker = () => {
  ...
  const trackerProduct = products.find(
    (product) => product.slug === 'charging_pad'
  )
      ...
      <div className={styles.container}>
        ...
        <div className={styles.details}>
          ...
          <p className={styles.additional_text}>
            Charging pad and USB cable for PetPulse Dog GPS Tracker.
            <br />
            Compatible with Qi-enabled devices, including PetPulse
            <br /> GPS, many modern smartphones and other wireless <br />
            devices.
            <br />
            Perfect as a spare or replacement charging pad.
            <br />
          ...
          <button
            ...
            onClick={() => addToCart('Charging pad', quantity)}
          >
            Add to Cart
          </button>
