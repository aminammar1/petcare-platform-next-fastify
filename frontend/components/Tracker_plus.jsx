...
const Tracker = () => {
  ...
  const trackerProduct = products.find(
    (product) => product.slug === 'tracker_plus'
  )
      ...
      <div className={styles.container}>
        ...
        <div className={styles.details}>
          ...
          <p className={styles.additional_text}>
            Track your dog’s location, activity,
            <br /> weight and more with no subscription needed.
          </p>
          ...
          <button
            ...
            onClick={() => addToCart('Tracker_plus', quantity)}
          >
            Add to Cart
          </button>
