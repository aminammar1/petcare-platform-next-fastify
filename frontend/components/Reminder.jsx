...
export default function Reminder() {
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await api.post('/save_reminder', formData)
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className={styles.inlineFields}>
                  <div className={styles.fieldContainer}>
                    <label className={styles.label} htmlFor="renewal-month">
                  ...
                  <div className={styles.fieldContainer}>
                    <label className={styles.label} htmlFor="current-insurance">
                      Who Do You Currently Hold Insurance With?
                    </label>
                    <input
                      type="text"
                ...
                <p className={styles.captcha}>
                  We will wait for you to join our community!
                </p>
                <img
                  src={'./image/pointer.gif'}
                  alt="pointer"
