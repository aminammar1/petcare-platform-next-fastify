  ...
  return (
    <div className={styles.containerplus}>
      ...
      <div className={styles.fullWidthImage}>
        ...
        <Link href="/tracker">
          <span className={styles.Explore_Monitor}>
            Explore PETPULSE Monitor
          </span>
        </Link>
      </div>

      <h1 className={styles.caption}>
        PETPULSE application, your partner in pet wellness..
      </h1>
      ...
      <div className={styles.dd3}>
        ...
        <p className={styles.paragraphe3}>
          PETPULSE is your go-to app for tracking your pet's health and
          well-being. With features designed to streamline pet care, including
          health records medication reminders, activity tracking, and
          appointment scheduling, PetPulse ensures your furry friend stays happy
          and healthy. Whether you're a pet parent or a pet professional,
          PetPulse makes it easy to stay organized and proactive in caring for
          your beloved companion.
        </p>
        <img
          src="./image/double.png"
          alt="double phone"
          className={styles.double_phone}
        />{' '}
        {/* Add this line */}
      </div>
      <div className={styles.cat1}>
        ...
        <div className={styles.takeCareTextContainer}>
          <h1 className={styles.takeCareText}>
            Take care of your pet with{' '}
            <span className={styles.takeCareText2}>PETPULSE</span>
          </h1>
        </div>
        <img
          src="./image/food.png"
          alt="food ball"
          className={styles.food_ball}
        />
      </div>
      <div className={styles.cat2}>
        <img src="./image/pp10.png" alt="line" className={styles.line} />
        <img
          src="./image/line_dog.png"
          alt="line_dog"
          className={styles.line_dog}
        />
      </div>
